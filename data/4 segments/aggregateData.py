...
# 16 segments per day, grouping by fours yields 4 segments per day.
df['group_id'] = df.groupby(['symbol', 'date']).cumcount() // 4
...
output_filename = 'all_stocks_intraday_4segments.csv'
