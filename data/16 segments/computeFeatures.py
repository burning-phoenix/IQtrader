...
df = pd.read_csv('/TradingModel_V4/16 segments/all_stocks_intraday_16segments.csv',
...
# Compute MACD (using 'close')
# Fast EMA (12 periods) and Slow EMA (26 periods)
...
df_final = df_final[df_final['datetime'] >= '2024-01-17 04:00:00']



# Save Transformed Data
output_filename = 'stockData_16segments_Features.csv'
