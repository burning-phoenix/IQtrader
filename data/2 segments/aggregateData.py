...
# 16 segments per day, grouping by eights yields 2 segments per day.
df['group_id'] = df.groupby(['symbol', 'date']).cumcount() // 8
...
output_filename = 'all_stocks_intraday_2segments.csv'
