...
# File names for each resolution and their associated weights
files_and_weights = {
...
# Calculate the weighted average for each metric using the provided weights
merged_df["weighted_Correlation"] = (
    merged_df["Correlation_1"] * files_and_weights['1']['weight'] +
    merged_df["Correlation_2"] * files_and_weights['2']['weight'] +
    merged_df["Correlation_4"] * files_and_weights['4']['weight'] +
    merged_df["Correlation_8"] * files_and_weights['8']['weight']
)
merged_df["weighted_Mutual Information"] = (
    merged_df["Mutual Information_1"] * files_and_weights['1']['weight'] +
    merged_df["Mutual Information_2"] * files_and_weights['2']['weight'] +
    merged_df["Mutual Information_4"] * files_and_weights['4']['weight'] +
    merged_df["Mutual Information_8"] * files_and_weights['8']['weight']
)
merged_df["weighted_Permutation Importance"] = (
    merged_df["Permutation Importance_1"] * files_and_weights['1']['weight'] +
    merged_df["Permutation Importance_2"] * files_and_weights['2']['weight'] +
    merged_df["Permutation Importance_4"] * files_and_weights['4']['weight'] +
    merged_df["Permutation Importance_8"] * files_and_weights['8']['weight']
)
merged_df["weighted_Tree-Based Importance"] = (
    merged_df["Tree-Based Importance_1"] * files_and_weights['1']['weight'] +
    merged_df["Tree-Based Importance_2"] * files_and_weights['2']['weight'] +
    merged_df["Tree-Based Importance_4"] * files_and_weights['4']['weight'] +
    merged_df["Tree-Based Importance_8"] * files_and_weights['8']['weight']
)


# Compute an overall weighted score by summing the weighted metrics
...
merged_df = merged_df[["feature", "weighted_Correlation", "weighted_Mutual Information", "weighted_Permutation Importance", "weighted_Tree-Based Importance"]]


# Save the final weighted feature names and overall scores to a CSV file
output_filename = 'final_weighted_feature_names.csv'
